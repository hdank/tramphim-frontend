...
}, "/home/vohaidang/Desktop/tramphim-v2/ui/src/seometas/SeoTheLoai.astro", void 0);
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$Layout, {}, { "default": async ($$result2) => renderTemplate`  ${renderComponent($$result2, "Header", Header, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/home/vohaidang/Desktop/tramphim-v2/ui/src/components/Header/Header", "client:component-export": "default" })} ${maybeRenderHead()}<main class="main-category-layout"> <div class="category-content-flex"> <section class="category-main-section"> ${renderComponent($$result2, "CategoryMovies", CategoryMovies, { "initialData": categoryData, "initialSlug": slug, "baseUrl": BASE_URL, "initialLimit": limit, "tittle": currentCategoryName, "client:load": true, "client:component-hydration": "load", "client:component-path": "/home/vohaidang/Desktop/tramphim-v2/ui/src/components/CategoryMovies/TheLoai", "client:component-export": "default" })} </section> </div> </main> <footer> ${renderComponent($$result2, "Footer", Footer, {})} </footer> `, "head": async ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "slot": "head" }, { "default": async ($$result3) => renderTemplate` ${renderComponent($$result3, "SeoTheLoai", $$SeoTheLoai, { "slug": slug, "currentCategoryName": currentCategoryName })} ` })}` })}`;
}, "/home/vohaidang/Desktop/tramphim-v2/ui/src/pages/the-loai/[slug].astro", void 0);

const $$file = "/home/vohaidang/Desktop/tramphim-v2/ui/src/pages/the-loai/[slug].astro";
