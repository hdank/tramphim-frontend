...
const SITE_URL = "https://hhkungfu.at1";
...
async function GET(context) {
  ...
  return rss({
    ...
    description: "Tổng hợp danh sách phim hoạt hình 3D Vietsub HD mới nhất, được cập nhật liên tục trong năm 2025.",
    site: SITE_URL,
    items: movies.map((movie) => ({
      title: `${movie.ten_phim || movie.title || "Hoạt hình không tên"} - Vietsub HD`,
      description: movie.mo_ta || movie.description || "Xem phim hoạt hình 3D Vietsub HD mới nhất với chất lượng cao.",
      pubDate: new Date(
