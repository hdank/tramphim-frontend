...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$Layout, {}, { "default": async ($$result2) => renderTemplate`  ${renderComponent($$result2, "Header", Header, { "client:load": true, "client:component-hydration": "load", "client:component-path": "E:/tramphim/tramphim-frontend/src/components/Header/Header", "client:component-export": "default" })} ${maybeRenderHead()}<main class="main-type-layout"> <div class="type-content-flex"> <section class="type-main-section"> ${renderComponent($$result2, "CategoryMovies", CategoryMovies, { "initialData": categoryData, "initialSlug": slug, "baseUrl": BASE_URL, "initialLimit": limit, "tittle": currentCategoryName, "client:load": true, "client:component-hydration": "load", "client:component-path": "E:/tramphim/tramphim-frontend/src/components/CategoryMovies/ChuDe", "client:component-export": "default" })} </section> </div> </main> <footer> ${renderComponent($$result2, "Footer", Footer, {})} </footer> `, "head": async ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "slot": "head" }, { "default": async ($$result3) => renderTemplate` ${renderComponent($$result3, "Seo", $$SeoLoaiPhim, { "slug": slug, "currentCategoryName": currentCategoryName })} ` })}` })}`;
}, "E:/tramphim/tramphim-frontend/src/pages/chu-de/[slug].astro", void 0);

const $$file = "E:/tramphim/tramphim-frontend/src/pages/chu-de/[slug].astro";
