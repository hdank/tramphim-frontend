/* empty css                                 */
import { e as createComponent, f as createAstro, h as addAttribute, r as renderTemplate, u as unescapeHTML, l as renderComponent, n as Fragment, m as maybeRenderHead } from '../chunks/astro/server_Boq9MD4A.mjs';
import 'piccolore';
...
const getBaseUrl$1 = (url) => {
  let baseUrl = url || "https://api.tramphim.com";
...
function SearchResultsWithFilter({
  ...
  const baseUrl = getBaseUrl$1(baseUrlProp);
...
}, "E:/tramphim/tramphim-frontend/src/seometas/SeoTimKiem.astro", void 0);
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const baseUrl = "https://api.tramphim.com";
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$Layout, {}, { "default": async ($$result2) => renderTemplate`  ${maybeRenderHead()}<main class="main-search-layout"> <div class="header-wrapper-search"> ${renderComponent($$result2, "Header", Header, { "client:load": true, "client:component-hydration": "load", "client:component-path": "E:/tramphim/tramphim-frontend/src/components/Header/Header", "client:component-export": "default" })} </div> <div class="content-columns-flex"> <div class="search-results-column"> ${renderComponent($$result2, "SearchResultsWithFilter", SearchResultsWithFilter, { "initialSearchMovies": movies, "searchKeyword": keyword, "baseUrl": baseUrl, "initialLimit": 10, "tittle": "Tìm kiếm", "client:load": true, "client:component-hydration": "load", "client:component-path": "E:/tramphim/tramphim-frontend/src/components/SearchMovies/SearchMovies", "client:component-export": "default" })} </div> <div class="top-movies-sidebar-column"> ${renderComponent($$result2, "TopMovies", TopMovies, { "movies": topmovies, "client:load": true, "client:component-hydration": "load", "client:component-path": "E:/tramphim/tramphim-frontend/src/components/TopMovies/TopMovies", "client:component-export": "default" })} </div> </div> </main> <footer> ${renderComponent($$result2, "Footer", Footer, {})} </footer> `, "head": async ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "slot": "head" }, { "default": async ($$result3) => renderTemplate` ${renderComponent($$result3, "SeoComponent", $$SeoTimKiem, { "keyword": keyword })} ` })}` })}`;
}, "E:/tramphim/tramphim-frontend/src/pages/tim-kiem/index.astro", void 0);
const $$file = "E:/tramphim/tramphim-frontend/src/pages/tim-kiem/index.astro";
const $$url = "/tim-kiem";
