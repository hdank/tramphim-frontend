...
import { a as alarmGif, E as Episodes, C as Comments } from '../../chunks/Comments_D8EOsp2Z.mjs';
import { F as Footer } from '../../chunks/index_Ce3Y9ZIG.mjs';
import { T as TopMovies } from '../../chunks/TopMovies_Dnd2_qIw.mjs';
import 'clsx';
export { renderers } from '../../renderers.mjs';

const qrfb = new Proxy({"src":"/_astro/qrfb.CT1jTx8l.png","width":1110,"height":1110,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "E:/tramphim/tramphim-frontend/src/assets/qrfb.png";
							}
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex w-full flex-row items-start gap-8 lg:w-[70%] 2xl:w-[75%]", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex w-full flex-1 flex-col items-start gap-3 lg:h-full lg:justify-between", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex w-full flex-col gap-1", children: [
          ...
          movie.mo_ta && /* @__PURE__ */ jsxs("div", { className: "hidden flex-col gap-1 py-1 text-xs sm:flex lg:text-sm", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex flex-row gap-2", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: `${isDescriptionExpanded ? "" : "line-clamp-2"} font-normal text-[#ECECEC]`, children: movie.mo_ta })
            ] }),
            movie.mo_ta.length > 150 && /* @__PURE__ */ jsx(
              "button",
              {
                onClick: () => setIsDescriptionExpanded(!isDescriptionExpanded),
                className: "ml-auto text-xs text-sky-400 hover:text-sky-300 transition-colors",
                children: isDescriptionExpanded ? "Thu gọn" : "Đọc thêm"
              }
            )
          ] })
        ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 rounded-lg bg-[#ffffff1a] p-4 lg:w-[25%]", children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-8 hidden flex-col items-center justify-center gap-2 sm:flex", children: [
          ...
          /* @__PURE__ */ jsx("h3", { className: "text-xs font-medium text-gray-300", children: "Tham gia group Facebook" })
        ] })
      ] })
    ] }),
    " "
...
}, "E:/tramphim/tramphim-frontend/src/seometas/SeoPhim.astro", void 0);
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  }, "style")}> <img${addAttribute(movie.banner_url, "src")} alt="banner phim" fetchpriority="high" decoding="async" class="hidden"> <div class="movie-banner-background"></div> <div class="movie-content-base"> <div class="header-shadow"> ${renderComponent($$result2, "Header", Header, { "client:load": true, "client:component-hydration": "load", "client:component-path": "E:/tramphim/tramphim-frontend/src/components/Header/Header", "client:component-export": "default" })} </div> <main class="main-content-layout"> ${renderComponent($$result2, "MovieDetail", MovieDetail, { "movie": movie, "firstEpisodeSlug": firstEpisodeSlug, "firstEpisodeType": firstEpisodeType, "client:load": true, "thongbao": thongbao, "initialIsFavorite": initialIsFavorite, "client:component-hydration": "load", "client:component-path": "E:/tramphim/tramphim-frontend/src/components/MovieDetail/MovieDetailStaticInfo", "client:component-export": "default" })} </main> </div> </div> <div class="breadcrumb-padding"> ${renderComponent($$result2, "Breadcrumb", Breadcrumb, { "movie": movie })} </div> <div class="page-wrapper-base"> <div class="main-column-flex"> <div class="detail-tabs-column"> ${renderComponent($$result2, "MovieTabsAndCast", MovieTabsAndCast, { "vietsubEpisodes": vietsub, "thuyetMinhEpisodes": thuyetminh, "longtiengEpisodes": longtieng, "slug": slug, "currentType": null, "movieTitle": movie.ten_phim, "trailer_url": movie.trailer_url, "phanlienquan": phanLienQuan, "actors": actors, "images": { images }, "initialSortAscending": sortEpisode, "client:load": true, "client:component-hydration": "load", "client:component-path": "E:/tramphim/tramphim-frontend/src/components/MovieDetail/MovieTab", "client:component-export": "default" })} <div class="comment-section-padding"> ${renderComponent($$result2, "Comments", Comments, { "slug": slug, "client:visible": true, "client:component-hydration": "visible", "client:component-path": "E:/tramphim/tramphim-frontend/src/components/Comments", "client:component-export": "default" })} </div> </div> <div class="sidebar-column"> ${renderComponent($$result2, "TopMovies", TopMovies, { "movies": topmovies, "client:idle": true, "client:component-hydration": "idle", "client:component-path": "E:/tramphim/tramphim-frontend/src/components/TopMovies/TopMovies", "client:component-export": "default" })} </div> </div> </div> <footer class="px-0"> ${renderComponent($$result2, "Footer", Footer, {})} </footer> `, "head": async ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "slot": "head" }, { "default": async ($$result3) => renderTemplate` ${renderComponent($$result3, "SEO", $$SeoPhim, { "movie": movie, "slug": slug })} ` })}` })}`;
}, "E:/tramphim/tramphim-frontend/src/pages/phim/[slug].astro", void 0);

const $$file = "E:/tramphim/tramphim-frontend/src/pages/phim/[slug].astro";
const $$url = "/phim/[slug]";
