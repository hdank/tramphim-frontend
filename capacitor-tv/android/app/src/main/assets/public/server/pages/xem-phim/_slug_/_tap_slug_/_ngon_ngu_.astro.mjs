/* empty css                                          */
import { e as createComponent, f as createAstro, r as renderTemplate, u as unescapeHTML, h as addAttribute, l as renderComponent, n as Fragment$1, m as maybeRenderHead } from '../../../../chunks/astro/server_Boq9MD4A.mjs';
import 'piccolore';
...
import { E as Episodes, C as Comments } from '../../../../chunks/Comments_D8EOsp2Z.mjs';
          ...
          "span",
          {
            ...
            children: /* @__PURE__ */ jsx(
              "svg",
              {
                ...
                children: /* @__PURE__ */ jsx("path", { d: "M5.055 7.06C3.805 6.347 2.25 7.25 2.25 8.69v6.62c0 1.44 1.555 2.343 2.805 1.628L12 12.938v3.372c0 1.44 1.555 2.343 2.805 1.628l7.108-4.061c1.26-.72 1.26-2.536 0-3.256l-7.108-4.061C13.555 5.716 12 6.62 12 8.06v3.372L5.055 7.06Z" })
              }
            )
          }
        )
...
}, "E:/tramphim/tramphim-frontend/src/seometas/SeoXemPhim.astro", void 0);
...
const $$ngonNgu = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.url.href;
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$Layout, {}, { "default": async ($$result2) => renderTemplate`  ${renderComponent($$result2, "Header", Header, { "client:idle": true, "client:component-hydration": "idle", "client:component-path": "E:/tramphim/tramphim-frontend/src/components/Header/Header", "client:component-export": "default" })} ${maybeRenderHead()}<main class="player-content-wrapper"> <div class="player-section-flex"> <section class="player-container-section"> ${renderComponent($$result2, "VideoPlayer", VideoPlayer, { "client:load": true, "originalUrl": finalVideoUrl, "slug": slug, "ngonngu": ngon_ngu, "sotap": tap_slug, "banner": banner, "poster": poster, "ten_phim": tenPhim, "activeServer": finalServer, "vietsubEpisodes": vietsubData, "thuyetminhEpisodes": thuyetminhData, "skipTimes": { intro: { end: skipIntroTime || 60 }, recap: null }, "client:component-hydration": "load", "client:component-path": "E:/tramphim/tramphim-frontend/src/components/VideoPlayer/VideoPlayer", "client:component-export": "default" })} ${renderComponent($$result2, "ServerButtons", ServerButtons, { "client:idle": true, "slug": slug, "so_tap": tap_slug, "ngon_ngu": ngon_ngu, "finalServer": finalServer, "hasSv1Video": hasSv1Video, "hasSv2Video": hasSv2Video, "hasSv3Video": hasSv3Video, "initialAutoSkip": autoSkipCookie, "client:component-hydration": "idle", "client:component-path": "E:/tramphim/tramphim-frontend/src/components/ServerButton/ServerButtons", "client:component-export": "default" })} </section> </div> <div class="movie-detail-divider"> ${renderComponent($$result2, "MovieDetail", MovieDetail, { "movie": movie, "client:load": true, "client:component-hydration": "load", "client:component-path": "E:/tramphim/tramphim-frontend/src/components/MovieDetail/MovieDetailPlayer", "client:component-export": "default" })} </div> <div class="episode-and-sidebar-flex"> <section class="episode-list-column"> ${renderComponent($$result2, "Episodes", Episodes, { "client:idle": true, "vietsub": vietsubData, "thuyetminh": thuyetminhData, "longtieng": longtiengData, "slug": slug, "movieTitle": tenPhim, "currentEpisodeSlug": tap_slug, "currentType": ngon_ngu, "initialSortAscending": sortEpisode, "client:component-hydration": "idle", "client:component-path": "E:/tramphim/tramphim-frontend/src/components/EposideList/EpisodeList", "client:component-export": "default" })} <div class="comment-section-padding"> ${renderComponent($$result2, "Comments", Comments, { "slug": slug, "client:visible": true, "client:component-hydration": "visible", "client:component-path": "E:/tramphim/tramphim-frontend/src/components/Comments", "client:component-export": "default" })} </div> <div class="recommend-section-wrapper"> ${renderComponent($$result2, "RecommendMovies", MovieCard, { "movies": deXuatData?.data, "title": "\u0110\u1EC1 Xu\u1EA5t Cho B\u1EA1n", "client:idle": true, "loading": false, "error": null, "client:component-hydration": "idle", "client:component-path": "E:/tramphim/tramphim-frontend/src/components/Recommended_Movies/RecommendedMovies", "client:component-export": "default" })} </div> </section> <aside class="sidebar-column"> ${renderComponent($$result2, "TopMovies", TopMovies, { "movies": topData?.data ?? [], "client:idle": true, "client:component-hydration": "idle", "client:component-path": "E:/tramphim/tramphim-frontend/src/components/TopMovies/TopMovies", "client:component-export": "default" })} </aside> </div> </main> <footer> ${renderComponent($$result2, "Footer", Footer, {})} </footer> `, "head": async ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment$1, { "slot": "head" }, { "default": async ($$result3) => renderTemplate` ${renderComponent($$result3, "Seo", $$SeoXemPhim, { "tenPhim": tenPhim, "tenKhac": tenKhac, "currentEpisode": displayEpisode, "currentType": ngon_ngu, "thumbnail": poster, "slug": slug, "mota": mota })} ` })}` })}`;
}, "E:/tramphim/tramphim-frontend/src/pages/xem-phim/[slug]/[tap_slug]/[ngon_ngu].astro", void 0);

const $$file = "E:/tramphim/tramphim-frontend/src/pages/xem-phim/[slug]/[tap_slug]/[ngon_ngu].astro";
