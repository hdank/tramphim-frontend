...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$Layout, {}, { "default": async ($$result2) => renderTemplate`  ${maybeRenderHead()}<div class="min-h-screen flex flex-col"> ${renderComponent($$result2, "Header", Header, { "client:load": true, "client:component-hydration": "load", "client:component-path": "E:/tramphim/tramphim-frontend/src/components/Header/Header", "client:component-export": "default" })} <main class="flex-1 w-full max-w-screen-xl container mx-auto  py-2 lg:py-8"> <section class="w-full"> ${renderComponent($$result2, "AllToPics", AllToPics, { "themesData": themesDataForReact, "client:load": true, "client:component-hydration": "load", "client:component-path": "E:/tramphim/tramphim-frontend/src/components/ToPics/AllToPics", "client:component-export": "default" })} </section> </main> <footer> ${renderComponent($$result2, "Footer", Footer, {})} </footer> </div> `, "head": async ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "slot": "head" })}` })}`;
}, "E:/tramphim/tramphim-frontend/src/pages/chu-de/index.astro", void 0);

const $$file = "E:/tramphim/tramphim-frontend/src/pages/chu-de/index.astro";
const $$url = "/chu-de";
