/* empty css                                    */
import { e as createComponent, f as createAstro, r as renderTemplate, u as unescapeHTML, h as addAttribute, l as renderComponent, n as Fragment, m as maybeRenderHead } from '../../chunks/astro/server_Boq9MD4A.mjs';
import 'piccolore';
...
function CategoryMovies({
  ...
  useEffect(() => {
    ...
    setFilters((prevFilters) => {
      if (prevFilters.the_loai !== newTheLoai || prevFilters.ngon_ngu !== (initialData?.filters?.ngon_ngu || "") || prevFilters.nam_phat_hanh !== (initialData?.filters?.nam_phat_hanh || "") || prevFilters.sort !== (initialData?.filters?.sort || "ngay-tao") || prevFilters.chieu_rap !== (initialData?.filters?.chieu_rap || "") || prevFilters.loai_phim !== (initialData?.filters?.loai_phim || "")) {
        return {
          ...prevFilters,
          the_loai: newTheLoai,
          ngon_ngu: initialData?.filters?.ngon_ngu || "",
    ...
    async (pageToFetch = 1) => {
      ...
      try {
        ...
        const newUrl = new URL(
          window.location.pathname.startsWith("/the-loai/") ? window.location.pathname : window.location.pathname,
  ...
  const handleClearFilters = () => {
    const defaultFilters = {
      the_loai: initialSlug || "",
      // Giữ lại slug của trang
      ngon_ngu: "",
      nam_phat_hanh: "",
      sort: "ngay-tao",
      chieu_rap: "",
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "mt-6", children: /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-row items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-row items-center justify-center gap-2", children: [
          ...
          /* @__PURE__ */ jsx("h2", { className: "bg-gradient-to-r from-white via-sky-100 to-cyan-100 bg-clip-text text-lg font-bold text-transparent lg:text-2xl", children: tittle })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center", children: totalPages > 1 && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "mt-2 h-px bg-gradient-to-r from-sky-500/50 via-cyan-500/30 to-transparent" })
    ] }) }),
...
const $$SeoTheLoai = createComponent(($$result, $$props, $$slots) => {
  ...
  const titleTag = `Phim ${currentCategoryName} M\u1EDBi Nh\u1EA5t 2025 | ${siteName}`;
  const seoDescription = `Tuy\u1EC3n ch\u1ECDn phim ${currentCategoryName} hay nh\u1EA5t, Vietsub mi\u1EC5n ph\xED t\u1EA1i ${siteName}. Kho phim phong ph\xFA, c\u1EADp nh\u1EADt nhanh, ch\u1EA5t l\u01B0\u1EE3ng HD, tr\u1EA3i nghi\u1EC7m m\u01B0\u1EE3t m\xE0 kh\xF4ng qu\u1EA3ng c\xE1o.`;
  ...
  return renderTemplate(_a || (_a = __template(["<title>", '</title><meta name="description"', '><meta name="robots" content="index, follow"><link rel="canonical"', '><meta property="og:title"', '><meta property="og:description"', '><meta property="og:url"', '><meta property="og:type" content="website"><meta property="og:locale" content="vi_VN"><meta property="og:site_name"', '><meta property="og:image"', '><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title"', '><meta name="twitter:description"', '><meta name="twitter:site" content="@onflix"><script type="application/ld+json">', "<\/script>"])), titleTag, addAttribute(seoDescription, "content"), addAttribute(currentUrl, "href"), addAttribute(titleTag, "content"), addAttribute(seoDescription, "content"), addAttribute(currentUrl, "content"), addAttribute(siteName, "content"), addAttribute(`${siteUrl}/thumb_web.png`, "content"), addAttribute(titleTag, "content"), addAttribute(seoDescription, "content"), unescapeHTML(JSON.stringify(breadcrumbSchema)));
}, "E:/tramphim/tramphim-frontend/src/seometas/SeoTheLoai.astro", void 0);
...
async function fetchTheLoaiData(theLoaiSlug, page, limit, searchParams) {
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const initialPage = Number(Astro2.url.searchParams.get("page") ?? "1");
  const limit = 30;
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$Layout, {}, { "default": async ($$result2) => renderTemplate`  ${renderComponent($$result2, "Header", Header, { "client:load": true, "client:component-hydration": "load", "client:component-path": "E:/tramphim/tramphim-frontend/src/components/Header/Header", "client:component-export": "default" })} ${maybeRenderHead()}<main class="main-category-layout"> <div class="category-content-flex"> <section class="category-main-section"> ${renderComponent($$result2, "CategoryMovies", CategoryMovies, { "initialData": categoryData, "initialSlug": slug, "baseUrl": BASE_URL, "initialLimit": limit, "tittle": currentCategoryName, "client:load": true, "client:component-hydration": "load", "client:component-path": "E:/tramphim/tramphim-frontend/src/components/CategoryMovies/TheLoai", "client:component-export": "default" })} </section> </div> </main> <footer> ${renderComponent($$result2, "Footer", Footer, {})} </footer> `, "head": async ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "slot": "head" }, { "default": async ($$result3) => renderTemplate` ${renderComponent($$result3, "SeoTheLoai", $$SeoTheLoai, { "slug": slug, "currentCategoryName": currentCategoryName })} ` })}` })}`;
}, "E:/tramphim/tramphim-frontend/src/pages/the-loai/[slug].astro", void 0);

const $$file = "E:/tramphim/tramphim-frontend/src/pages/the-loai/[slug].astro";
const $$url = "/the-loai/[slug]";
